            ...
            <div class="form-horizontal">
                <fieldset>
                    <div class="control-group">											
                        ...
                        <div class="controls">
                            {{ Form::text('tgl-debet',date('d-m-Y'),array('class'=>'input-small datepicker','id'=>'debet-tgl-text','required','autocomplete'=>'off','placeholder'=>'Tanggal')) }}
                            {{ Form::text('debet',null,array('class'=>'input-medium uang','id'=>'debet-text','required','autocomplete'=>'off','placeholder'=>'Nominal')) }}
                            <a class="btn btn-success btn-simpan-debet">SIMPAN</a>
                        </div> <!-- /controls -->				
                    </div> <!-- /control-group -->
                </fieldset>
            </div>
            ...
            <div class="form-horizontal">
                <fieldset>
                    <div class="control-group">											
                        <label class="control-label">Input nominal </label>
                        <div class="controls">
                            {{ Form::text('tgl-kredit',date('d-m-Y'),array('class'=>'input-small datepicker','id'=>'kredit-tgl-text','required','autocomplete'=>'off','placeholder'=>'Tanggal')) }}
                            {{ Form::text('kredit',null,array('class'=>'input-medium uang','id'=>'kredit-text','required','autocomplete'=>'off','placeholder'=>'Nominal')) }}
                            <a class="btn btn-warning btn-simpan-kredit">SIMPAN</a>
                        </div> <!-- /controls -->				
                    </div> <!-- /control-group -->
                </fieldset>
            </div>
